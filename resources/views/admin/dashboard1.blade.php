                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-green">Total haadir hari ini</h4>
                                        <h6 class="text-muted m-b-0">10</h6>
                                    </div>
                                    <div class="col-4 text-right">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        <h4 class="text-c-red">Total sakit hari inij</h4>
                                        <h6 class="text-muted m-b-0">0</h6>
                                    </div>
                                    <div class="col-4 text-right">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-8">
                                        ...
                                        <h6 class="text-muted m-b-0">1</h6>
                                    </div>
                                    <div class="col-4 text-right">
